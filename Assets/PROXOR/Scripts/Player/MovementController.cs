...
public class MovementController
{
    ...
    private IEnumerator StepCoroutine()
    {
        while (true)
        {
            ...
            _impulseSource.DefaultVelocity.y = _speed == _runSpeed ? defaultVelocity * _walkSpeed / _runSpeed : defaultVelocity;
            _impulseSource.ImpulseDefinition.ImpulseDuration = stepInterval;
